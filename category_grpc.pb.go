...
const (
	Category_Add_FullMethodName           = "/com.itcoursee.message.Category/Add"
	Category_Get_FullMethodName           = "/com.itcoursee.message.Category/Get"
	Category_Subcategories_FullMethodName = "/com.itcoursee.message.Category/Subcategories"
	Category_Update_FullMethodName        = "/com.itcoursee.message.Category/Update"
	Category_Move_FullMethodName          = "/com.itcoursee.message.Category/Move"
	Category_Delete_FullMethodName        = "/com.itcoursee.message.Category/Delete"
)
...
type CategoryClient interface {
	...
	Subcategories(ctx context.Context, in *category.SubcategoriesReq, opts ...grpc.CallOption) (*category.SubcategoriesRsp, error)
	// 更新
...
func (c *categoryClient) Subcategories(ctx context.Context, in *category.SubcategoriesReq, opts ...grpc.CallOption) (*category.SubcategoriesRsp, error) {
	out := new(category.SubcategoriesRsp)
	err := c.cc.Invoke(ctx, Category_Subcategories_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CategoryServer interface {
	...
	// 按父分类获取子分类列表
	// protolint:disable:next MAX_LINE_LENGTH
	Subcategories(context.Context, *category.SubcategoriesReq) (*category.SubcategoriesRsp, error)
	// 更新
...
func (UnimplementedCategoryServer) Subcategories(context.Context, *category.SubcategoriesReq) (*category.SubcategoriesRsp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Subcategories not implemented")
}
...
func _Category_Subcategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(category.SubcategoriesReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CategoryServer).Subcategories(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Category_Subcategories_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServer).Subcategories(ctx, req.(*category.SubcategoriesReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Category_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.itcoursee.message.Category",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Category_Subcategories_Handler,
		},
		{
			MethodName: "Update",
	...
	Metadata: "com/itcoursee/message/category.proto",
}
