...
type LectureClient interface {
	...
	// 审核回调
	Reviewed(ctx context.Context, in *callback.ReviewReq, opts ...grpc.CallOption) (*callback.ReviewRsp, error)
	// 视频关联
...
func (c *lectureClient) Add(ctx context.Context, in *lecture.AddReq, opts ...grpc.CallOption) (*lecture.AddRsp, error) {
	...
	err := c.cc.Invoke(ctx, "/com.itcoursee.message.Lecture/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lectureClient) Get(ctx context.Context, in *lecture.GetReq, opts ...grpc.CallOption) (*lecture.GetRsp, error) {
	...
	err := c.cc.Invoke(ctx, "/com.itcoursee.message.Lecture/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lectureClient) GetsByCourse(ctx context.Context, in *lecture.GetsByCourseReq, opts ...grpc.CallOption) (*lecture.GetsByCourseRsp, error) {
	...
	err := c.cc.Invoke(ctx, "/com.itcoursee.message.Lecture/GetsByCourse", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lectureClient) GetPlayback(ctx context.Context, in *lecture.GetPlaybackReq, opts ...grpc.CallOption) (*lecture.GetPlaybackRsp, error) {
	...
	err := c.cc.Invoke(ctx, "/com.itcoursee.message.Lecture/GetPlayback", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lectureClient) Update(ctx context.Context, in *lecture.UpdateReq, opts ...grpc.CallOption) (*lecture.UpdateRsp, error) {
	...
	err := c.cc.Invoke(ctx, "/com.itcoursee.message.Lecture/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lectureClient) Reviewed(ctx context.Context, in *callback.ReviewReq, opts ...grpc.CallOption) (*callback.ReviewRsp, error) {
	out := new(callback.ReviewRsp)
	err := c.cc.Invoke(ctx, "/com.itcoursee.message.Lecture/Reviewed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lectureClient) Resource(ctx context.Context, in *lecture.ResourceReq, opts ...grpc.CallOption) (*lecture.ResourceRsp, error) {
	...
	err := c.cc.Invoke(ctx, "/com.itcoursee.message.Lecture/Resource", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lectureClient) Delete(ctx context.Context, in *lecture.DeleteReq, opts ...grpc.CallOption) (*lecture.DeleteRsp, error) {
	...
	err := c.cc.Invoke(ctx, "/com.itcoursee.message.Lecture/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LectureServer interface {
	...
	// 审核回调
	Reviewed(context.Context, *callback.ReviewReq) (*callback.ReviewRsp, error)
	// 视频关联
...
func (UnimplementedLectureServer) Reviewed(context.Context, *callback.ReviewReq) (*callback.ReviewRsp, error) {
...
func _Lecture_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.message.Lecture/Add",
	}
...
func _Lecture_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.message.Lecture/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Lecture_GetsByCourse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.message.Lecture/GetsByCourse",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Lecture_GetPlayback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.message.Lecture/GetPlayback",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Lecture_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.message.Lecture/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Lecture_Reviewed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.message.Lecture/Reviewed",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LectureServer).Reviewed(ctx, req.(*callback.ReviewReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Lecture_Resource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.message.Lecture/Resource",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Lecture_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.message.Lecture/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
