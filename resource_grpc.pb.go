...
func (c *resourceClient) Initiate(ctx context.Context, in *resource.InitiateReq, opts ...grpc.CallOption) (*resource.InitiateRsp, error) {
	...
	err := c.cc.Invoke(ctx, "/com.itcoursee.message.Resource/Initiate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *resourceClient) Url(ctx context.Context, in *resource.UrlReq, opts ...grpc.CallOption) (*resource.UrlRsp, error) {
	...
	err := c.cc.Invoke(ctx, "/com.itcoursee.message.Resource/Url", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *resourceClient) Paging(ctx context.Context, in *resource.PagingReq, opts ...grpc.CallOption) (*resource.PagingRsp, error) {
	...
	err := c.cc.Invoke(ctx, "/com.itcoursee.message.Resource/Paging", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *resourceClient) Complete(ctx context.Context, in *resource.CompleteReq, opts ...grpc.CallOption) (*resource.CompleteRsp, error) {
	...
	err := c.cc.Invoke(ctx, "/com.itcoursee.message.Resource/Complete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *resourceClient) Update(ctx context.Context, in *resource.UpdateReq, opts ...grpc.CallOption) (*resource.UpdateRsp, error) {
	...
	err := c.cc.Invoke(ctx, "/com.itcoursee.message.Resource/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *resourceClient) Reviewed(ctx context.Context, in *callback.ReviewReq, opts ...grpc.CallOption) (*callback.ReviewRsp, error) {
	out := new(callback.ReviewRsp)
	err := c.cc.Invoke(ctx, "/com.itcoursee.message.Resource/Reviewed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *resourceClient) Delete(ctx context.Context, in *resource.DeleteReq, opts ...grpc.CallOption) (*resource.DeleteRsp, error) {
	...
	err := c.cc.Invoke(ctx, "/com.itcoursee.message.Resource/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedResourceServer) Reviewed(context.Context, *callback.ReviewReq) (*callback.ReviewRsp, error) {
...
func _Resource_Initiate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.message.Resource/Initiate",
	}
...
func _Resource_Url_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.message.Resource/Url",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Resource_Paging_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.message.Resource/Paging",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Resource_Complete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.message.Resource/Complete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Resource_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.message.Resource/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Resource_Reviewed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.message.Resource/Reviewed",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ResourceServer).Reviewed(ctx, req.(*callback.ReviewReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Resource_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.message.Resource/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
