...
const (
	Lecture_Add_FullMethodName          = "/com.itcoursee.message.Lecture/Add"
	Lecture_Review_FullMethodName       = "/com.itcoursee.message.Lecture/Review"
	Lecture_Get_FullMethodName          = "/com.itcoursee.message.Lecture/Get"
	Lecture_GetsByCourse_FullMethodName = "/com.itcoursee.message.Lecture/GetsByCourse"
	Lecture_GetPlayback_FullMethodName  = "/com.itcoursee.message.Lecture/GetPlayback"
	Lecture_Update_FullMethodName       = "/com.itcoursee.message.Lecture/Update"
	Lecture_Reviewed_FullMethodName     = "/com.itcoursee.message.Lecture/Reviewed"
	Lecture_BindPlayback_FullMethodName = "/com.itcoursee.message.Lecture/BindPlayback"
	Lecture_Delete_FullMethodName       = "/com.itcoursee.message.Lecture/Delete"
)
...
type LectureClient interface {
	...
	// 提交审核
	Review(ctx context.Context, in *lecture.ReviewReq, opts ...grpc.CallOption) (*lecture.ReviewRsp, error)
	// 获取
	...
	// 内容关联
	// protolint:disable:next MAX_LINE_LENGTH
	BindPlayback(ctx context.Context, in *lecture.BindPlaybackReq, opts ...grpc.CallOption) (*lecture.BindPlaybackRsp, error)
	// 删除
...
func (c *lectureClient) Review(ctx context.Context, in *lecture.ReviewReq, opts ...grpc.CallOption) (*lecture.ReviewRsp, error) {
	out := new(lecture.ReviewRsp)
	err := c.cc.Invoke(ctx, Lecture_Review_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lectureClient) Reviewed(ctx context.Context, in *callback.ReviewedReq, opts ...grpc.CallOption) (*callback.ReviewedRsp, error) {
	out := new(callback.ReviewedRsp)
	err := c.cc.Invoke(ctx, Lecture_Reviewed_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lectureClient) BindPlayback(ctx context.Context, in *lecture.BindPlaybackReq, opts ...grpc.CallOption) (*lecture.BindPlaybackRsp, error) {
	out := new(lecture.BindPlaybackRsp)
	err := c.cc.Invoke(ctx, Lecture_BindPlayback_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LectureServer interface {
	...
	// 提交审核
	Review(context.Context, *lecture.ReviewReq) (*lecture.ReviewRsp, error)
	// 获取
	...
	// 内容关联
	// protolint:disable:next MAX_LINE_LENGTH
	BindPlayback(context.Context, *lecture.BindPlaybackReq) (*lecture.BindPlaybackRsp, error)
	// 删除
...
func (UnimplementedLectureServer) Review(context.Context, *lecture.ReviewReq) (*lecture.ReviewRsp, error) {
...
func (UnimplementedLectureServer) Reviewed(context.Context, *callback.ReviewedReq) (*callback.ReviewedRsp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Reviewed not implemented")
}
func (UnimplementedLectureServer) BindPlayback(context.Context, *lecture.BindPlaybackReq) (*lecture.BindPlaybackRsp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BindPlayback not implemented")
}
...
func _Lecture_Review_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(lecture.ReviewReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LectureServer).Review(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Lecture_Review_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LectureServer).Review(ctx, req.(*lecture.ReviewReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Lecture_Reviewed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(callback.ReviewedReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LectureServer).Reviewed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Lecture_Reviewed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LectureServer).Reviewed(ctx, req.(*callback.ReviewedReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Lecture_BindPlayback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(lecture.BindPlaybackReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LectureServer).BindPlayback(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Lecture_BindPlayback_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LectureServer).BindPlayback(ctx, req.(*lecture.BindPlaybackReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Lecture_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.itcoursee.message.Lecture",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Review",
			Handler:    _Lecture_Review_Handler,
		},
		{
			MethodName: "Get",
		...
		{
			MethodName: "Reviewed",
			Handler:    _Lecture_Reviewed_Handler,
		},
		{
			MethodName: "BindPlayback",
			Handler:    _Lecture_BindPlayback_Handler,
		},
		{
			MethodName: "Delete",
	...
	Metadata: "com/itcoursee/message/lecture.proto",
}
