...
var (
	filter_Lecture_Get_0 = &utilities.DoubleArray{Encoding: map[string]int{"course": 0, "id": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
var (
	filter_Lecture_GetsByCourse_0 = &utilities.DoubleArray{Encoding: map[string]int{"course": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
