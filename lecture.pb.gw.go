...
func request_Lecture_Resource_0(ctx context.Context, marshaler runtime.Marshaler, client LectureClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq lecture.ResourceReq
	var metadata runtime.ServerMetadata
...
func local_request_Lecture_Resource_0(ctx context.Context, marshaler runtime.Marshaler, server LectureServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq lecture.ResourceReq
	var metadata runtime.ServerMetadata
...
func request_Lecture_Resource_1(ctx context.Context, marshaler runtime.Marshaler, client LectureClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq lecture.ResourceReq
	var metadata runtime.ServerMetadata
...
func local_request_Lecture_Resource_1(ctx context.Context, marshaler runtime.Marshaler, server LectureServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq lecture.ResourceReq
	var metadata runtime.ServerMetadata
...
func RegisterLectureHandlerServer(ctx context.Context, mux *runtime.ServeMux, server LectureServer) error {
	...
	mux.Handle("PUT", pattern_Lecture_Resource_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/com.itcoursee.message.Lecture/Resource", runtime.WithHTTPPathPattern("/courses/{course}/lectures/{id}/resources"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Lecture_Resource_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Lecture_Resource_0(annotatedContext, mux, outboundMarshaler, w, req, response_Lecture_Resource_0{resp}, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("PUT", pattern_Lecture_Resource_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/com.itcoursee.message.Lecture/Resource", runtime.WithHTTPPathPattern("/lectures/{id}/resources"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Lecture_Resource_1(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Lecture_Resource_1(annotatedContext, mux, outboundMarshaler, w, req, response_Lecture_Resource_1{resp}, mux.GetForwardResponseOptions()...)
...
func RegisterLectureHandlerClient(ctx context.Context, mux *runtime.ServeMux, client LectureClient) error {
	...
	mux.Handle("PUT", pattern_Lecture_Resource_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/com.itcoursee.message.Lecture/Resource", runtime.WithHTTPPathPattern("/courses/{course}/lectures/{id}/resources"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Lecture_Resource_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("PUT", pattern_Lecture_Resource_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/com.itcoursee.message.Lecture/Resource", runtime.WithHTTPPathPattern("/lectures/{id}/resources"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Lecture_Resource_1(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
type response_Lecture_Resource_0 struct {
	proto.Message
}

func (m response_Lecture_Resource_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*lecture.ResourceRsp)
	return response.Lecture
}

type response_Lecture_Resource_1 struct {
	proto.Message
}

func (m response_Lecture_Resource_1) XXX_ResponseBody() interface{} {
	response := m.Message.(*lecture.ResourceRsp)
	return response.Lecture
}
...
var (
	...
	pattern_Lecture_Resource_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"courses", "course", "lectures", "id", "resources"}, ""))

	pattern_Lecture_Resource_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2}, []string{"lectures", "id", "resources"}, ""))
...
var (
	...
	forward_Lecture_Resource_0 = runtime.ForwardResponseMessage

	forward_Lecture_Resource_1 = runtime.ForwardResponseMessage
