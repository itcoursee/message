...
const (
	Chapter_Add_FullMethodName          = "/com.itcoursee.message.Chapter/Add"
	Chapter_Get_FullMethodName          = "/com.itcoursee.message.Chapter/Get"
	Chapter_GetsByCourse_FullMethodName = "/com.itcoursee.message.Chapter/GetsByCourse"
	Chapter_Update_FullMethodName       = "/com.itcoursee.message.Chapter/Update"
	Chapter_Delete_FullMethodName       = "/com.itcoursee.message.Chapter/Delete"
)
