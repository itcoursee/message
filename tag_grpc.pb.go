...
const (
	Tag_Add_FullMethodName    = "/com.itcoursee.message.Tag/Add"
	Tag_Get_FullMethodName    = "/com.itcoursee.message.Tag/Get"
	Tag_Paging_FullMethodName = "/com.itcoursee.message.Tag/Paging"
	Tag_Update_FullMethodName = "/com.itcoursee.message.Tag/Update"
	Tag_Delete_FullMethodName = "/com.itcoursee.message.Tag/Delete"
)
