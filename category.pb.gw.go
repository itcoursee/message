...
func RegisterCategoryHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CategoryServer) error {
	...
	mux.Handle("GET", pattern_Category_Subcategories_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/com.itcoursee.message.Category/Subcategories", runtime.WithHTTPPathPattern("/categories/{id}/subcategories"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterCategoryHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CategoryClient) error {
	...
	mux.Handle("GET", pattern_Category_Subcategories_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/com.itcoursee.message.Category/Subcategories", runtime.WithHTTPPathPattern("/categories/{id}/subcategories"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
