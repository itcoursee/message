...
const (
	Recommend_Add_FullMethodName    = "/com.itcoursee.message.Recommend/Add"
	Recommend_Paging_FullMethodName = "/com.itcoursee.message.Recommend/Paging"
	Recommend_Top_FullMethodName    = "/com.itcoursee.message.Recommend/Top"
	Recommend_Delete_FullMethodName = "/com.itcoursee.message.Recommend/Delete"
)
...
type RecommendClient interface {
	...
	// 最佳
	Top(ctx context.Context, in *recommend.TopReq, opts ...grpc.CallOption) (*recommend.TopRsp, error)
	// 删除
...
func (c *recommendClient) Top(ctx context.Context, in *recommend.TopReq, opts ...grpc.CallOption) (*recommend.TopRsp, error) {
	out := new(recommend.TopRsp)
	err := c.cc.Invoke(ctx, Recommend_Top_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RecommendServer interface {
	...
	// 最佳
	Top(context.Context, *recommend.TopReq) (*recommend.TopRsp, error)
	// 删除
...
func (UnimplementedRecommendServer) Top(context.Context, *recommend.TopReq) (*recommend.TopRsp, error) {
...
func _Recommend_Top_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(recommend.TopReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecommendServer).Top(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Recommend_Top_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecommendServer).Top(ctx, req.(*recommend.TopReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Recommend_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.itcoursee.message.Recommend",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Top",
			Handler:    _Recommend_Top_Handler,
		},
		{
			MethodName: "Delete",
	...
	Metadata: "com/itcoursee/message/recommend.proto",
}
